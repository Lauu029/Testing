...
public class Money implements Comparable {
	...
	public String toString() {
		double a= cantidad/100;
		
		String amount = Double.toString(a);
		
		return amount + " " + divisa.getName();
	}
	 ...
	 */
	public Money negate() {
		return (new Money(cantidad*-1,this.divisa));
	}
	...
	public int compareTo(Object o) {
		if(o==this) return 0;
		if(o==null) return valorUniversal();
		
		return valorUniversal()- ((Money) o).valorUniversal();
